...
echo "Initial IRSA_PGO_ANNOTATION_KEY_VALUE: ${IRSA_PGO_ANNOTATION_KEY_VALUE}"
...
export IRSA_PGO_ANNOTATION_KEY_VALUE=${IRSA_PGO_ANNOTATION_KEY_VALUE:-''}
...
echo "Using IRSA_PGO_ANNOTATION_KEY_VALUE: ${IRSA_PGO_ANNOTATION_KEY_VALUE}"
...
(
  ...
  set_var "IRSA_PGO_ANNOTATION_KEY_VALUE" "" "${ACCOUNT_BASE_PATH}" "${ENV}/irsa-role/pgo/arn" "${IRSA_TEMPLATE}"
