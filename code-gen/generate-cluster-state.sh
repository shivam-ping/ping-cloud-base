...
echo "Initial PGO_BUCKET_NAME: ${PGO_BUCKET_NAME}"
echo "Initial PINGBINARY_BUCKET_NAME: ${PINGBINARY_BUCKET_NAME}"
echo "Initial PINGFEDCLUSTER_BUCKET_NAME: ${PINGFEDCLUSTER_BUCKET_NAME}"
...
(
  ...
  echo "Using PGO_BUCKET_NAME: ${PGO_BUCKET_NAME}"
  echo "Using PINGBINARY_BUCKET_NAME: ${PINGBINARY_BUCKET_NAME}"
  echo "Using PINGFEDCLUSTER_BUCKET_NAME: ${PINGFEDCLUSTER_BUCKET_NAME}"
  echo "Using IRSA_PING_ANNOTATION_KEY_VALUE: ${IRSA_PING_ANNOTATION_KEY_VALUE}"
  echo "Using KARPENTER_ROLE_ANNOTATION_KEY_VALUE: ${KARPENTER_ROLE_ANNOTATION_KEY_VALUE}"
  echo "Using IRSA_INGRESS_ANNOTATION_KEY_VALUE: ${IRSA_INGRESS_ANNOTATION_KEY_VALUE}"
  echo "Using NLB_NGX_PUBLIC_ANNOTATION_KEY_VALUE: ${NLB_NGX_PUBLIC_ANNOTATION_KEY_VALUE}"
